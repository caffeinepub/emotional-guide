...
import { getStoryLinks } from '../utils/moodResourceLinks';

interface StoriesTabContentProps {
  mood: string;
}

export default function StoriesTabContent({ mood }: StoriesTabContentProps) {
  const storyLinks = getStoryLinks(mood);

  return (
    <div className="space-y-3">
      <p className="text-sm text-muted-foreground">
        Stories and narratives that resonate with how you're feeling
      </p>
