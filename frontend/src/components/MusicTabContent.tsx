...
import { getMusicLinks } from '../utils/moodResourceLinks';

interface MusicTabContentProps {
  mood: string;
}

export default function MusicTabContent({ mood }: MusicTabContentProps) {
  const musicLinks = getMusicLinks(mood);

  return (
    <div className="space-y-3">
      <p className="text-sm text-muted-foreground">
        Music recommendations curated for your mood
      </p>
