...
import { getMeditationLinks } from '../utils/moodResourceLinks';

interface MeditationTabContentProps {
  mood: string;
}

export default function MeditationTabContent({ mood }: MeditationTabContentProps) {
  const meditationLinks = getMeditationLinks(mood);

  return (
    <div className="space-y-3">
      <p className="text-sm text-muted-foreground">
        Guided meditations and mindfulness practices for your current state
      </p>
