...
export class Backend implements backendInterface {
    ...
    async addCheckIn(arg0: string, arg1: string): Promise<CheckInWithResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.addCheckIn(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addEmpatheticStory(arg0: EmpatheticStory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addEmpatheticStory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addFollowUpPrompt(arg0: FollowUpPrompt): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getUserCheckIns(arg0: Principal): Promise<Array<EmotionalCheckIn>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCheckIns(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasCheckIns(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasCheckIns(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
